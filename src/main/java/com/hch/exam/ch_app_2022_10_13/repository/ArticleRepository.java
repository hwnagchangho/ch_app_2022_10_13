...
//  @Select("INSERT INTO article SET title=#{title}, body=#{body}")
  ...
  @Select("""
          ...
          """)
  public List<Article> getForPrintArticles(@Param("boardId") int boardId, @Param("searchKeywordTypeCode") String searchKeywordTypeCode,
 ...
 public int getArticleHitCount(@Param("id") int id);
  ...
  @Update("""
          ...
          """)
  int decreaseGoodReactionPoint(@Param("id") int id);
